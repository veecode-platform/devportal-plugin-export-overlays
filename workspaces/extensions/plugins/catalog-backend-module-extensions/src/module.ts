...
// OVERLAY (devportal-plugin-export-overlays, feat/backstage-1.50): the only change
// vs upstream rhdh-plugins is the catalogProcessingExtensionPoint import below —
// Backstage 1.50 graduated it out of @backstage/plugin-catalog-node/alpha into the
// package's main export. Without this, a 1.50-targeted export of this module imports
// `undefined` for `catalog`, the backend's module dependency graph crashes
// ("Cannot read properties of undefined (reading 'id')") and the whole catalog plugin
// — hence the marketplace — fails to start. Drop this overlay once upstream ports it.
