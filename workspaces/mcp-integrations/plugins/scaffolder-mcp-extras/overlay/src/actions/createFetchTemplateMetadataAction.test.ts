 ...
 */
/*
 * Overlay copy of the upstream test, adapted to the overlay's
 * fetchSoftwareTemplateMetadata signature (adds the mandatory AuthService
 * parameter used for scaffolder token exchange). Keep call sites in sync
 * with the overlay createFetchTemplateMetadataAction.ts.
 */
